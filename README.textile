...
I have replaced the event system with "HSL":http://code.google.com/p/hxhsl/. However, you need the latest SVN version to workaround a hxcpp bug("see here":http://lists.motion-twin.com/pipermail/haxe/2010-September/038589.html).
