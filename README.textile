...
I have replaced the event system with "HSL":http://code.google.com/p/hxhsl/. However, you need the latest SVN version to workaround a hxcpp bug("see here":http://lists.motion-twin.com/pipermail/haxe/2010-September/038589.html). Simply get the SVN version of HSL and run @haxelib dev hsl-1 absolut/path/to/hxhsl/hsl source@ and @haxelib dev hsl-pico-1 absolut/path/to/hxhsl/hsl-pico source@.
