...
I have replaced the event system with "HSL":http://code.google.com/p/hxhsl/. However, a little patch is needed for HSL to work in C++ target ("see here":http://lists.motion-twin.com/pipermail/haxe/2010-September/038589.html)

It is under active development, but most of the API have been wrapped. Please also expect some minor API cleanup in the future.
